...
// this is a helper function to compute total duration and total lectures from the lectures array
...
// to calculate the total minutes, duration, lectures, and validate the form before submission
...
// if filled then ok else it will show a error
    ...
    <div className={addPageStyles.pageContainer}>
      ...
      <div className={addPageStyles.contentContainer}>
        <div className={addPageStyles.headerContainer}>
          <div className={addPageStyles.headerGlow}></div>         
            <h1 className={addPageStyles.headerTitle}>Add New Course</h1>
        </div>    
        <p className={addPageStyles.headerSubtitle}>Craft your course with ease and precision. Fill in the details below to create a comprehensive and engaging learning experience for your students.</p>
      ...
      {showLectureForm && (
        <div className={addPageStyles.modalOverlay}>
          <div className={addPageStyles.modal}>
            <div className={addPageStyles.modalHeader}>
              <div className={addPageStyles.modalIconContainer("bg-blue-100")}>
                <Video className="text-blue-600" size={20} />
              </div>
              <h3 className={addPageStyles.modalTitle}>Add Lecture</h3>
            </div>
            ...
            <div className={addPageStyles.modalContent}>
              ...
              {currentLecture.chapters.length > 0 && (
                <div>
                  <label className={addPageStyles.inputLabel}>Chapters</label>
